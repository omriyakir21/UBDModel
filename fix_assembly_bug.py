...
source_datasets = ['PssmFiles_propagated_asa/PssmFiles_propagated_asa_0_1/PSSM%s.txt'%k for k in range(5)]
target_datasets = ['0509_dataset/labels_fold%s.txt'%k for k in range(1,6)]
Lmin = 10
