...
sys.path.append(r'C:\Users\omriy\UBDAndScanNet\ScanNet_Ub')
import pandas as pd
from ScanNet_Ub.preprocessing import PDBio
import numpy as np
download_batch = 10
try:
    ...
    batch = 0
table = pd.read_csv(r'C:\Users\omriy\UBDAndScanNet\newUBD\UBDModel\protein_classification\uniprotnamecsCSV.csv')
all_examples = []
